...
//  TaskTwoV1
//
//  Created by Анастасия Ларина on 27.08.2021.
//
    ...
    static func showFailureAlert(title: String, message: String, controller: UIViewController?) {
        DispatchQueue.main.async {
            ...
            if let controller = controller {
                ...
                guard let viewController = UIApplication.shared.windows.first!.rootViewController as? NewsViewController else { return }
