...
class CollectionDogsViewCell: UICollectionViewCell {
    ...
    static let identifaer = "CollectionDogsViewCell"

    static func nib() -> UINib {
        return  UINib(nibName: "CollectionDogsViewCelll", bundle: nil
        )
    }
