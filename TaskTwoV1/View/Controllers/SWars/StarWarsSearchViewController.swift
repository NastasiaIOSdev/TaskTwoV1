...
class StarWarsSearchViewController: UIViewController {
    ...
    let cellIdentifier = "StarWarsItemCollectionViewCell"
    ...
    func setupCollectionView() {
        ...
        let nib = UINib(nibName: "StarWarsItemCollectionViewCell", bundle: nil)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == segueIdentifier {
            if let viewC = segue.destination as? StarWarsDetailPageViewController {
