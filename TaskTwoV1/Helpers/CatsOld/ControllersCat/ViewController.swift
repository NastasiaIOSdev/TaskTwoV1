    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.row % 3 == 0 {
              if let cell = tableView.dequeueReusableCell(
                    withIdentifier: "FullWidthTableViewCell") as? FullWidthTableViewCell {
...
//                cell.contentView.layer.shadowOpacity = 0.5
              ...
              if let cell2 = tableView.dequeueReusableCell(
                    withIdentifier: "HalfWidthTableViewCell") as? HalfWidthTableViewCell {
            ...
            if let cell3 = tableView.dequeueReusableCell(
                withIdentifier: "TableViwInTableViewCell") as? TableViwInTableViewCell {
                return cell3
            }
        }
