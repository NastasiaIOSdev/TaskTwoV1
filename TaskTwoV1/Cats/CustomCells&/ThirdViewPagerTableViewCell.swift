...
class ThirdViewPagerTableViewCell: UITableViewCell, UICollectionViewDelegate,
    ...
    override func awakeFromNib() {
        super.awakeFromNib()
        pagerCollectionView.register(ThirdCollectionViewCell.nib(),
                                     forCellWithReuseIdentifier: ThirdCollectionViewCell.identifaer)
    ...
    func collectionView(_ collectionView: UICollectionView,
        ...
        guard let cell = pagerCollectionView.dequeueReusableCell(
                withReuseIdentifier: ThirdCollectionViewCell.identifaer,
                for: indexPath) as? ThirdCollectionViewCell else { fatalError()
        }
